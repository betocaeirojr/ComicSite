	...
	<body>
		...
		<form action=”char_transact.php” name=”theform” method=”post”>
			<table border=”0” cellpadding=”15” bgcolor=”<?php echo $tablebg; ?>”>
				...
				<tr>
					<td>Powers:<br><font size=”2” color=”#990000”> (Ctrl-click to<br>select multiple<br>powers)</font>
					</td>
					<td>
				...
				<tr>
					<td>Lair Location:<br><font size=”2” color=”#990000”> (address,<br>city, state, zip)</font>
					</td>
					<td>
				...
				<tr>
					<td colspan=”2”>
						<input type=”submit” name=”action” value=”<?php echo $subtype; ?> Character”>
						<input type=”reset”>
